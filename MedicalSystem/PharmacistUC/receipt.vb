...
Public Class receipt
    ...
    Private Sub loaditems()
        Try
            sqL = "SELECT sell.medicinename,sell.qty,sell.unitprice,sell.totalamt,transactionDetails.amtpaid,transactionDetails.balanceamt FROM sell INNER JOIN transactionDetails ON sell.invoiceNO = transactionDetails.invoiceID where sell.invoiceNO ='" & Trim(lblInvoice.Text) & " '"
            ConnDB()
